 ...
 * under the License.
 */
namespace jaq\Request\V20160801;

class ModifyInfoPreventionRequest extends \RpcAcsRequest
{
	function  __construct()
	{
		parent::__construct("jaq", "2016-08-01", "ModifyInfoPrevention");
	}
	...
	public function getModifyInfoList() {
		return $this->modifyInfoList;
	}

	public function setModifyInfoList($modifyInfoList) {
		$this->modifyInfoList = $modifyInfoList;
		$this->queryParameters["ModifyInfoList"]=$modifyInfoList;
	}
