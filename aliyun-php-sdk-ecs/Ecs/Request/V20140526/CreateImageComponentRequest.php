 ...
 *
 * Request of CreateImageComponent
 *
 ...
 */
class CreateImageComponentRequest extends \RpcAcsRequest
{
    ...
    {
        $this->requestParameters['SystemType'] = $systemType;
        $this->queryParameters['SystemType'] = $systemType;
